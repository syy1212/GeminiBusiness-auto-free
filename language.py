    ...
    def __init__(self):
        ...
        self.translations = {
            "cn": {
                ...
                "cookie_attempt_failed": "第 {attempts} 次尝试未获取到SessionToken，{retry_interval}秒后重试...",
                "cookie_max_attempts": "已达到最大尝试次数({max_attempts})，获取SessionToken失败",
                ...
                "gemini_account_info": "Gemini 账号信息:\n邮箱: {email}\n密码: {password}",
            ...
            "en": {
                ...
                "cookie_attempt_failed": "Attempt {attempts} failed to get SessionToken, retrying in {retry_interval} seconds...",
                "cookie_max_attempts": "Reached maximum attempts ({max_attempts}), failed to get SessionToken",
                ...
                "gemini_account_info": "Gemini account information:\nEmail: {email}\nPassword: {password}",
...
if __name__ == "__main__":
    ...
    print(get_translation("gemini_account_info", email="test@example.com", password="password123")) 